      ...
      <div className={landing.container}>
        ...
        <div className={landing.marketing_container}>
          <div className={landing.marketing_wrapper}>
            ...
            <div className={landing.carousel_wrapper_mobile}>
              <CarouselTopMobile />
            </div>
          </div>
        </div>
        ...
        <div className={landing.works_container}>
          <div className={landing.card_wrapper}>
            ...
            <div className={landing.works_content}>
              <p>
                We help vendors gain visibility more consistently to their
                customer base.
              </p>
            </div>
          </div>
          <div className={landing.card_wrapper}>
            ...
            <div className={landing.works_content}>
              <p>
                As the customer, we can seamlessly support your local food
                vendor through a one stop shop search platform.
              </p>
            </div>
          </div>
          <div className={landing.card_wrapper}>
            ...
            <div className={landing.works_content}>
              <p>
                See what you like? We have a seamless order request process for
                both sides. Win-win
              </p>
            </div>
          </div>
        </div>
        <div className={landing.title_header}>
          {' '}
          Our Spotlight Vendors For This Month
        </div>
        ...
        <div className={landing.works_container}>
          <div className={landing.card_wrapper}>
            ...
            <div className={landing.works_content}>
              <p>
                “I just moved to Austin and wanted to support local from the
                start. This made it so easy!” - Alandra S.
              </p>
            </div>
          </div>
          <div className={landing.card_wrapper}>
            ...
            <div className={landing.works_content}>
              <p>
                “Market Avenue helped me find new found favorite vendors. Its
                like a whole new city to me!” - Sam B.
              </p>
            </div>
          </div>
          <div className={landing.card_wrapper}>
            ...
            <div className={landing.works_content}>
              <p>
                “As a vendor this helped so many stressors I used to have
                throughout my week; now I can focus more time on my craft. It’s
                great!” - Tracee W.
              </p>
            </div>
          </div>
