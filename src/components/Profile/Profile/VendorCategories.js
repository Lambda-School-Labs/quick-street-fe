...
const VendorCategories = ({ vendorInfo, setVendorInfo }) => {
  ...
  return (
    <div className={profile.input_wrapper} data-testid="vendorcat-wrapper">
      {/* CHECKBOX PROD. CATEGORY */}
      <div className={`${profile.checkbox_wrapper}`}>
        <div className={`${profile.checkbox_inner_wrapper}`}>
          <input
            checked={
              categoriesOnFile && categoriesOnFile.indexOf("Baked goods") !== -1
                ? true
                : false
            }
            onChange={handleSelect}
            id="Baked Goods"
            className={`${profile.checkbox_input}`}
            name="Baked Goods"
            type="checkbox"
            value="Baked goods"
          />
          <label
            className={`form-check-label ${profile.checkbox_label}`}
            for="Baked Goods"
          >
            Baked goods
          </label>
        ...
        <div className={`${profile.checkbox_inner_wrapper}`}>
          <input
            checked={
              categoriesOnFile && categoriesOnFile.indexOf("Beverages") !== -1
                ? true
                : false
            }
            onChange={handleSelect}
        ...
        <div className={`${profile.checkbox_inner_wrapper}`}>
          <input
            checked={
              categoriesOnFile && categoriesOnFile.indexOf("Breads") !== -1
                ? true
                : false
            }
            onChange={handleSelect}
        ...
        <div className={`${profile.checkbox_inner_wrapper}`}>
          <input
            checked={
              categoriesOnFile && categoriesOnFile.indexOf("Fruits") !== -1
                ? true
                : false
            }
            onChange={handleSelect}
        ...
        <div className={`${profile.checkbox_inner_wrapper}`}>
          <input
            checked={
              categoriesOnFile && categoriesOnFile.indexOf("Vegetables") !== -1
                ? true
                : false
            }
            onChange={handleSelect}
        ...
        <div className={`${profile.checkbox_inner_wrapper}`}>
          <input
            checked={
              categoriesOnFile && categoriesOnFile.indexOf("Spreads") !== -1
                ? true
                : false
            }
            onChange={handleSelect}
        ...
        <div className={`${profile.checkbox_inner_wrapper}`}>
          <input
            checked={
              categoriesOnFile && categoriesOnFile.indexOf("Other") !== -1
                ? true
                : false
            }
            onChange={handleSelect}
